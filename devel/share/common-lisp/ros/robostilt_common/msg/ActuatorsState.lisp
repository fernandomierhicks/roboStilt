...
(cl:defclass <ActuatorsState> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (actuators
    :reader actuators
    :initarg :actuators
    :type (cl:vector robostilt_common-msg:ActuatorState)
   :initform (cl:make-array 0 :element-type 'robostilt_common-msg:ActuatorState :initial-element (cl:make-instance 'robostilt_common-msg:ActuatorState)))
   (have_all_been_homed
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ActuatorsState>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'actuators)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'robostilt_common-msg:ActuatorState))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ActuatorsState>)))
  ...
  "b738e1ec17f4222e8b4a3330fc699bb7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ActuatorsState)))
  "Returns md5sum for a message object of type 'ActuatorsState"
  "b738e1ec17f4222e8b4a3330fc699bb7")
