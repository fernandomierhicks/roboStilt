...
;//! \htmlinclude robostilt_state_message.msg.html

(cl:defclass <robostilt_state_message> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass robostilt_state_message (<robostilt_state_message>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <robostilt_state_message>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'robostilt_state_message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robostilt_common-msg:<robostilt_state_message> is deprecated: use robostilt_common-msg:robostilt_state_message instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <robostilt_state_message>))
...
(cl:defmethod name-val ((m <robostilt_state_message>))
...
(cl:defmethod is_supporting-val ((m <robostilt_state_message>))
  ...
  (is_supporting m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <robostilt_state_message>) ostream)
  "Serializes a message object of type '<robostilt_state_message>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <robostilt_state_message>) istream)
  "Deserializes a message object of type '<robostilt_state_message>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robostilt_state_message>)))
  "Returns string type for a message object of type '<robostilt_state_message>"
  "robostilt_common/robostilt_state_message")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robostilt_state_message)))
  "Returns string type for a message object of type 'robostilt_state_message"
  "robostilt_common/robostilt_state_message")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<robostilt_state_message>)))
  "Returns md5sum for a message object of type '<robostilt_state_message>"
  "7b6f28c055f5a9e7c3caa539d494bf54")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'robostilt_state_message)))
  "Returns md5sum for a message object of type 'robostilt_state_message"
  "7b6f28c055f5a9e7c3caa539d494bf54")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<robostilt_state_message>)))
  "Returns full string definition for message of type '<robostilt_state_message>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'robostilt_state_message)))
  "Returns full string definition for message of type 'robostilt_state_message"
  (cl:format cl:nil "# This is a message that holds data abou the general state of the robo~%#~%# name holds the name of each leg~%# is_supporting=true when that leg is currenlty supporting weight of the robot. Otherwise its false~%#~%# Each leg is uniquely identified by its name~%# The header specifies the time at which the leg states were recorded. All the leg states~%# in one message have to be recorded at the same time.~%#~%# This message consists of a multiple arrays, one for each part of the leg state. ~%#~%# All arrays in this message should have the same size, or be empty.~%# This is the only way to uniquely associate the joint name with the correct~%# states.~%~%Header header~%~%string[] name~%bool[] is_supporting~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <robostilt_state_message>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <robostilt_state_message>))
  "Converts a ROS message object to a list"
  (cl:list 'robostilt_state_message
