...
(cl:defclass <RoboStiltStateMessage> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass RoboStiltStateMessage (<RoboStiltStateMessage>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <RoboStiltStateMessage>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'RoboStiltStateMessage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robostilt_common-msg:<RoboStiltStateMessage> is deprecated: use robostilt_common-msg:RoboStiltStateMessage instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <RoboStiltStateMessage>))
...
(cl:defmethod name-val ((m <RoboStiltStateMessage>))
...
(cl:defmethod is_supporting-val ((m <RoboStiltStateMessage>))
  ...
  (is_supporting m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RoboStiltStateMessage>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RoboStiltStateMessage>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RoboStiltStateMessage>)))
  "Returns string type for a message object of type '<RoboStiltStateMessage>"
  "robostilt_common/RoboStiltStateMessage")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RoboStiltStateMessage)))
  "Returns string type for a message object of type 'RoboStiltStateMessage"
  "robostilt_common/RoboStiltStateMessage")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RoboStiltStateMessage>)))
  "Returns md5sum for a message object of type '<RoboStiltStateMessage>"
  "7b6f28c055f5a9e7c3caa539d494bf54")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RoboStiltStateMessage)))
  "Returns md5sum for a message object of type 'RoboStiltStateMessage"
  "7b6f28c055f5a9e7c3caa539d494bf54")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RoboStiltStateMessage>)))
  "Returns full string definition for message of type '<RoboStiltStateMessage>"
  (cl:format cl:nil "# This is a message that holds data abou the general state of the robo~%#~%# name holds the name of each leg~%# is_supporting=true when that leg is currenlty supporting weight of the robot. Otherwise its false~%#~%# Each leg is uniquely identified by its name~%# The header specifies the time at which the leg states were recorded. All the leg states~%# in one message have to be recorded at the same time.~%#~%# This message consists of a multiple arrays, one for each part of the leg state. ~%#~%# All arrays in this message should have the same size, or be empty.~%# This is the only way to uniquely associate the joint name with the correct~%# states.~%~%Header header~%~%string[] name~%bool[] is_supporting  #legs are in indexes 1-6~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RoboStiltStateMessage)))
  "Returns full string definition for message of type 'RoboStiltStateMessage"
  (cl:format cl:nil "# This is a message that holds data abou the general state of the robo~%#~%# name holds the name of each leg~%# is_supporting=true when that leg is currenlty supporting weight of the robot. Otherwise its false~%#~%# Each leg is uniquely identified by its name~%# The header specifies the time at which the leg states were recorded. All the leg states~%# in one message have to be recorded at the same time.~%#~%# This message consists of a multiple arrays, one for each part of the leg state. ~%#~%# All arrays in this message should have the same size, or be empty.~%# This is the only way to uniquely associate the joint name with the correct~%# states.~%~%Header header~%~%string[] name~%bool[] is_supporting  #legs are in indexes 1-6~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RoboStiltStateMessage>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RoboStiltStateMessage>))
  "Converts a ROS message object to a list"
  (cl:list 'RoboStiltStateMessage
