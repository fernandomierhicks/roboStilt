...
class robostilt_state_message {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new robostilt_state_message(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new robostilt_state_message(null);
...
module.exports = robostilt_state_message;
